...
class Trivia(object):
    ...
    def show_question(self):
        ...
        print_text(font2, 190, 450, 'Press Key 1-4 To Answer', purple)
        print_text(font2, 160, 480, 'Press Key 0 To Create New Question', purple)
